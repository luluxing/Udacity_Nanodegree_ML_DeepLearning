...
for train_index, test_index in kf:
	...
	save_name = "10fold_" + str(xx) + "_model_1layer_10fold.ckpt"
	save_path = os.path.join('.', 'kfold_checkpoint_1layer', save_name)
...
valid_name = "10fold_1"
valid_path = os.path.join('.', 'kfold_accuracy_1layer', valid_name)
...
w = open('confusion_1layer_10fold','w')
np.save(w, m)
