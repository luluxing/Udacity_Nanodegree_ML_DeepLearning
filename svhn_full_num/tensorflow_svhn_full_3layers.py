...
for train_index, test_index in kf:
	...
	save_name = "10fold_" + str(xx) + "_model_3layers_10fold.ckpt"
	save_path = os.path.join('.', 'kfold_checkpoint_3layers', save_name)
...
valid_name = "10fold_1"
valid_path = os.path.join('.', 'kfold_accuracy_3layers', valid_name)
...
w = open('confusion_3layers_10fold_2','w')
np.save(w, m)
